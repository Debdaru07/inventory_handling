...
import { Archive, Clipboard, Icon, Layout, LucideIcon, Menu, SlidersHorizontal, Users } from 'lucide-react'
...
// This will be the function which calls the Sidebar links behaviour and colors.
const SidebarLink = ({
  href,
  icon: Icon, 
  label, 
  ...
  return (
    <Link href={href}>
      <div className={`cursor-pointer flex items-center ${isCollapsed ? `justify-center py-4` : 'justify-start px-8 py-4'} hover: text-blue-500 hover:bg-blue-100 gap-3 transition-colors ${isActive ? 'bg-blue-200' : ''}`}>
...
const Sidebar = () => {
  ...
  return <div className= {sidebarClassNames}>
    ...
    <div>
      <p className='text-center text-xs text-gray-500'>©2024 DEBSTOCK</p>
    </div>
  </div>
}
